                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                switch (item.getItemId()) {
                                    case R.id.MenuEdit:
                                        ...
                                        final Dialog dialog = new Dialog(MainActivity.this);//建立一個dialog
                                        ...
                                        Log.d(TAG, "onMenuItemClick: "+(MapList.size() - getAdapterPosition() - 1));
                                        BtDialogOK.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {//在dialog裡面按確定之後要做什麼事情
                                                if (!EtDialogArticle.getText().toString().equals("") && !EtDialogTitle.getText().toString().equals("")) {
                                                    ...
                                                    Toast toast = Toast.makeText(MainActivity.this, "此欄位不能為空白", Toast.LENGTH_SHORT);
                                                    toast.setGravity(Gravity.CENTER | Gravity.TOP, 0, 0);
                                                    toast.show();
                                                }
                                            }
